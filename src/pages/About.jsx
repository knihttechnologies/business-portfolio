        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full">
          {[{
            ...
            >
              ...
              <img src={item.img} alt={item.title} className="rounded-lg mb-4 w-full h-32 object-cover shadow-lg group-hover:shadow-cyan-400/30 transition-shadow" />
              <h4 className="text-lg font-bold mb-2 text-white drop-shadow-lg tracking-wide group-hover:text-cyan-200 transition-colors">{item.title}</h4>
              <p className="text-sm text-center text-cyan-100/90 group-hover:text-cyan-50 transition-colors">{item.desc}</p>
            </motion.div>
          ))}
        </div>
      </div>
