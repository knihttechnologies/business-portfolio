    ...
    <PagesLayout>
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-8">
          {[1,2,3,4,5,6].map((id) => (
            <div key={id} className="bg-white/10 rounded-xl shadow-lg p-6 flex flex-col">
              <img src={`https://source.unsplash.com/random/400x200?sig=${id}`} alt="Blog" className="rounded-lg mb-4 w-full h-40 object-cover" />
              <h4 className="text-lg font-bold mb-2">Blog Post Title {id}</h4>
              <p className="text-sm text-white/80 mb-2">This is a summary of the blog post. It covers news, events, or announcements relevant to Kniht Technologies.</p>
        ...
        <div className="bg-white/10 rounded-xl shadow-lg p-6 flex flex-col items-center">
          ...
          <div className="w-full h-24 bg-gray-200 flex items-center justify-center rounded-lg">Ad Placeholder</div>
        </div>
      </div>
    </PagesLayout>
  );
