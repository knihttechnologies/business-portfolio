...
const HomeHero = () => {
  return (
    <div className="relative flex flex-col items-center justify-center py-5 px-2 sm:px-4 md:px-8 mt-20 min-h-[calc(100vh-5rem)]">
        <motion.div
        ...
        <motion.p
            ...
            className="max-w-2xl text-sm sm:text-base md:text-lg text-center text-black dark:text-white mb-8"
        >
