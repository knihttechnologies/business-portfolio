...
const headerStyles = [
  {
    ...
    navLinkClassName: "flex items-center gap-2 text-white/90 hover:text-yellow-400 transition font-medium px-3 py-1 rounded-lg hover:bg-white/10",
    showIcons: true,
  },
  {
    label: 'Gradient Bar',
    ...
    logoClassName: "w-auto max-w-xs",
    navLinkClassName: "relative text-white font-medium px-3 py-1 group",
    showIcons: false,
    navLinkHoverEffect: (
  ...
  },
  {
    ...
    logoClassName: "w-auto max-w-xs",
    navLinkClassName: "flex flex-col items-center text-white hover:text-fuchsia-400 transition",
    showIcons: true,
  ...
  },
  {
    ...
    logoClassName: "w-auto max-w-xs",
    navLinkClassName: "text-indigo-900 font-semibold px-3 py-1 rounded-lg hover:bg-indigo-100/40 hover:text-fuchsia-600 transition",
    navLinkProps: (i) => ({
